...
class Home extends React.Component {
	componentDidMount() {
		this.props.queryUserStatistics();
	}
...
module.exports = connect(state => state, dispatch => bindActionCreators({ 'queryUserStatistics': actions.queryUserStatistics }, dispatch))(TMainContainer()(Home));