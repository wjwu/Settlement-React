...
import { TCol, TTree, TTable, TCard } from '../../components';
			...
			<div>
				...
				<Row gutter={24}>
					...
					<TCol xs={24} sm={17} md={17} lg={18}>
						<TCard title='用户数据'>
							<TTable rowKey='ID' columns={columns} total={users.TotalCount} dataSource={users.List} loading={queryingUsers} onLoad={this.onTTableLoad}/>
						</TCard>
					</TCol>
				</Row>
			</div>
